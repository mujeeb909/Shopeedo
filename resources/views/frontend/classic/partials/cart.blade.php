...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown"
    data-display="static" title="{{ translate('Cart') }}" style="background: white">
    <span class="mr-2 circle" style="">
        <svg xmlns="http://www.w3.org/2000/svg" width="25.52" height="24.89" viewBox="0 0 24 20.562">
