...
class CheckoutController
{
    public function apply_coupon_code(Request $request)
    {
        ...
        $cart_items = Cart::where('user_id', auth()->user()->id)->where('owner_id', $coupon->user_id)->active()->get();
        ...
        if($coupon_discount>0){
            Cart::where('user_id', auth()->user()->id)->where('owner_id', $coupon->user_id)->active()->update([
